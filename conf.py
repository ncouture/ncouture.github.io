...
BLOG_AUTHOR = "@UnixNick"  # (translatable)
BLOG_TITLE = "ncouture.github.io"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://ncouture.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = "nicolas@stormvault.net"
BLOG_DESCRIPTION = "This is my personal github pages."  # (translatable)
...
LUXON_DATE_FORMAT = {
    DEFAULT_LANG: {'preset': True, 'format': 'yyyy-MM-dd HH:mm'},
}
DATE_FANCINESS = 0
...
GLOBAL_CONTEXT = {
    ...
    "mdl__cachebusting": "1",
    "mdl__fixed_header": True,
    "mdl__fixed_drawer": True,
    "mdl__no_drawer_button": True,
    "mdl__no_desktop_drawer_button": True,
    "mdl__multiple_header": True,
    "mdl__header_scroll": True,
    "mdl__header_waterfall": True,
    "mdl__header_waterfall_hide_top": True,
    "mdl__header_transparent": True,
    "mdl__header_seamed": False,
    "mdl__footer": "Nikola!",
    "mdl__navigation_large_screen_only": False,
    "mdl__drawer_small_screen_only": False,
    "mdl__custom_css": True,
    "mdl__custom_js": True,
    "drawer_title": "Drawer titl",
    "drawer_logo_url": "https://upload.wikimedia.org/wikipedia/commons/thumb/5/54/Palermo-Museo-Archeologico-bjs-11.jpg/800px-Palermo-Museo-Archeologico-bjs-11.jpg",
    "drawer_show_title": "",
    "drawer_description": "this is my drawer description",
    "drawer_note": "drawer note",
    "title_row_middle": True,
    "navigation_row_middle": True,
